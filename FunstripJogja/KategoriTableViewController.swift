...
class KategoriTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://localhost/WisataJogja/index.php/api/getKat").responseJSON{ (responseData) -> Void in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var id_kategori = serverid["id_kat"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let id_kategori = arrKategori[indexPath.row]["id_kat"]
