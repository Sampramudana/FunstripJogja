...
class HomeMenuTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://localhost/WisataJogja/index.php/api/getWisata").responseJSON{ (responseData) -> Void in
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        isiSelected = task["isi_wisatajogja"] as! String
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "passData" {
            if let indexPath = self.tableView.indexPathForSelectedRow {
                ...
                controller.passIsi = value["isi_wisatajogja"] as! String
            }
        }
    }
