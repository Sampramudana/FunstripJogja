...
class BeritaKategoriTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://localhost/WisataJogja/index.php/api/getWisataByIdKategori"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var id = serverid["id_wisatajogja"]
        let judul = serverid["judul"]
        let nama_kategori = serverid["nama_kategori"]
        let isiBerita = serverid["isi_wisatajogja"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectedIsi = task["isi_wisatajogja"] as! String
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "passDetail" {
            if let indexPath = self.tableView.indexPathForSelectedRow {
                ...
                controller.isitextPass = value["isi_wisatajogja"] as! String
